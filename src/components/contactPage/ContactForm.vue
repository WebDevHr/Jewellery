<template>
  <div
    class="my-5 col-xl-5 col-12 d-flex justify-content-center align-items-center fontFamilyCourgette px-3"
  >
    <div class="col-12">
      <form class="border rounded p-4" @submit.prevent="">
        <div class="mb-3">
          ...
          />
          <div id="emailHelp" class="text-start form-text ms-2"></div>
        </div>
        <div class="mb-3">
          <label
            for="exampleInputEmail1"
          ...
          <div id="emailHelp" class="text-start form-text ms-2">
            Mailinizi kimse ile Paylaşmayız.
          </div>
        </div>
        <div class="mb-3">
          <label
          ...
          <input
            ...
            placeholder="Bizimle ilitişim nedeninizi konu olarak yaznız"
        ...
        <div class="mb-3">
          ...
          <textarea
            ...
            rows="3"
            placeholder="Detaylı bir şekilde konuyu açıklayın, lütfen."
